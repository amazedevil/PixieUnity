...
namespace Pixie.Unity
{
    ...
    //2 bytes content length
    //N bytes content
    class PXReliableDeliveryProtocol : PXProtocolBase
    {
        ...
        public override void Initialize(IPXProtocolContact feedbackReceiver) {
        ...
        public override async Task StartReading() {
            while (true) {
                try {
        ...
        public override async Task SendMessage(byte[] message) {
        ...
        public override async Task SendResponse(ushort messageId, byte[] response) {
        ...
        public override PXProtocolState GetState() {
            return state;
        }
